//http://sharpertutorials.com/vista-style-glass-buttons/
...
namespace Power_Mplayer
{
    ...
    public class GlassButton : Button
    {
        ...
        private Color _hovercolor = SystemColors.Control;
        ...
        private void InitializeComponent()
        {
            ...
            this.HoverColor = SystemColors.Control;
        ...
        private void DrawGlass(Graphics gr, Rectangle rectBar)
        {
            ...
            Color BaseColor = (_status == State.Normal) ? this.BackColor : this.HoverColor;
            ...
            {
                case State.Click:
                    ColorBacklight = GetDarkerColor(BaseColor, 20);
                    ColorFillBK = GetDarkerColor(BaseColor, 40);
                    ColorBorder = GetDarkerColor(BaseColor, 60);
                    break;
                case State.Hover:
                    ColorBacklight = GetLighterColor(BaseColor, 5);
                    ColorFillBK = GetLighterColor(BaseColor, 10);
                    ColorBorder = GetDarkerColor(BaseColor, 100);
                    break;
                case State.Normal:
                default:
                    ColorBacklight = this.BackColor;
                    ColorFillBK = GetDarkerColor(BaseColor, 85);
                    ColorBorder = GetDarkerColor(BaseColor, 85);
                    break;
            }
...
/*
            GraphicsPath rectBarPath = new GraphicsPath();
            rectBarPath.AddEllipse(rectBar.X, rectBar.Y, rectBar.Width - 1, rectBar.Height - 1);
            GraphicsPath rectBarPathHalf = new GraphicsPath();
            rectBarPathHalf.AddEllipse(rectBar.X, rectBar.Y, rectBar.Width - 1, (rectBar.Height - 1) / 2);
*/
